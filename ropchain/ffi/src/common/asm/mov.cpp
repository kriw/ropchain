...
OptROP fromLea(const Operand &op1, const Operand &op2, const Gadgets &gadgets,
               RegSet &aval);
OptROP fromLeaWithOffset(const Operand &op1, const Operand &op2,
                         const Gadgets &gadgets, RegSet &aval);
OptROP fromXorXor(const Operand &op1, const Operand &op2,
                  const Gadgets &gadgets, RegSet &aval);
OptROP fromXorOr(const Operand &op1, const Operand &op2, const Gadgets &gadgets,
                 RegSet &aval);
OptROP fromXchg(const Operand &op1, const Operand &op2, const Gadgets &gadgets,
                RegSet &aval);

OptROP findWithoutXchg(const Operand &op1, const Operand &op2,
                       const Gadgets &gadgets, RegSet &aval) {
...
OptROP Mov::find(const Operand &op1, const Operand &op2, const Gadgets &gadgets,
                 RegSet &aval) {
